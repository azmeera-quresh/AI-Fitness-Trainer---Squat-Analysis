...
if view == 'Side View':
    upload_process_frame = ProcessFrameSide(thresholds=thresholds, flip_frame=True)
else: # Front View
    upload_process_frame = ProcessFrameFront(thresholds=thresholds, flip_frame=True)
