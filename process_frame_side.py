...
class ProcessFrameSide:
    def __init__(self, thresholds, flip_frame = False):
        ...
        self.state_tracker = {
            ...
            # 0 --> Bend Backwards, 1 --> Bend Forward, 2 --> Keep shin straight, 3 --> Deep squat, 4 --> Reset Counter
        ...
        self.FEEDBACK_ID_MAP = {
                                ...
                                4: ('Resetting COUNTERS due to inactivity!!!', 135, (255, 100, 100)) # Added entry for reset message
                               }
    ...
    def process(self, frame: np.array, pose):
        ...
        if keypoints.pose_landmarks:
            ...
            if offset_angle > self.thresholds['OFFSET_THRESH']:
                ...
                # Call _show_feedback here for front-facing inactivity
                self.state_tracker['COUNT_FRAMES'][self.state_tracker['DISPLAY_TEXT']]+=1
                frame = self._show_feedback(frame, self.state_tracker['COUNT_FRAMES'], self.FEEDBACK_ID_MAP, False) # No lower hips for front view
                ...
                draw_text(
                    frame, 
                    'Camera not aligned properly / Body not visible!!!', 
                ...
                # Update DISPLAY_TEXT based on COUNT_FRAMES
            ...
            # Camera is aligned properly.
                ...
                dist_r_sh_hip = abs(right_foot_coord[1] - right_shldr_coord[1]) # Corrected typo: right_shldr_coord instead of right_shldr_coord)[1]
            ...
            self.state_tracker['COUNT_FRAMES'][self.state_tracker['DISPLAY_TEXT']]+=1
            frame = self._show_feedback(frame, self.state_tracker['COUNT_FRAMES'], self.FEEDBACK_ID_MAP, False) # No lower hips here
            ...
            self.state_tracker['INACTIVE_TIME_FRONT'] = 0.0
            self.state_tracker['INCORRECT_POSTURE'] = False
            # self.state_tracker['DISPLAY_TEXT'] = np.full((5,), False) # Keep DISPLAY_TEXT[4] true for the reset message
            # self.state_tracker['COUNT_FRAMES'] = np.zeros((5,), dtype=np.int64) # Keep COUNT_FRAMES[4] updating for the reset message
            self.state_tracker['start_inactive_time_front'] = time.perf_counter()

            # Ensure other feedback messages are cleared
